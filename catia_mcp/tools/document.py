...
class DocumentTools:
    ...
    def _new_part(self, name: str | None = None) -> str:
        ...
        # Documents.Add() returns a dispatch proxy that may not have .Part
        # pre-generated by gencache. Wrap in CDispatch for late binding.
        import win32com.client.dynamic
        doc = win32com.client.dynamic.CDispatch(raw_doc)
        if name:
            try:
                doc.Part.Name = name
