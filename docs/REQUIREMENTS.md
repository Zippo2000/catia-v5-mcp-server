...
| Sketcher | 11 | 2D-Geometrie-Erstellung und -Bearbeitung |
| Part Design | 15 | 3D-Feature-Erstellung (Pad, Pocket, Fillet, etc.) |
| Assembly | 9 | Baugruppen-Verwaltung und Constraints |
...
| FR-05.1–05.11 | Sketcher | `tools/sketcher.py` | `test_sketcher_tools.py` |
| FR-06.1–06.15 | Part Design | `tools/part_design.py` | `test_part_design_tools.py` |
| FR-07.1–07.9 | Assembly | `tools/assembly.py` | `test_assembly_tools.py` |
| FR-08.1–08.6 | Measurement | `tools/measurement.py` | `test_measurement_tools.py` |
